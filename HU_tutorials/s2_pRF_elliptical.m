...
%   SR is ratio of the standard deviations of the 2D Gaussian in the
%           columns to rows
...
% row in the spot that corresponds to the ratio parameter.  this
% indicates to fix the ratio parameter and not optimize it.
boundsFIX = bounds;
boundsFIX(1,5) = NaN;
